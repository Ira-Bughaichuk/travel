    ...
    return (
      <div
        ...
        tablet:flex tablet:justify-between tablet:text-[33px] tablet:font-thin tablet:leading-[33px]
          ...
          desktop:px-[225px] desktop:w-[1280px] desktop:bottom-[104px]
          transition-opacity ease-in duration-300`}
      >
        <button
          type="button"
          className="uppercase desktop:opacity-80 hover:opacity-100 focus:opacity-100 transition-opacity ease-in duration-300"
          ref={prevBtnRef}
        >
          Back
        </button>
