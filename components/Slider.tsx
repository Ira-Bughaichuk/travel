...
export default function Slider() {
  ...
  return (
    <>
    <Swiper  className="w-full h-full relative"
          ref={swiperRef}
          ...
          modules={[EffectFade]}>
            ...
            {contextSlider.map((itemSlide, index) => (<SwiperSlide key={itemSlide.id} className="swiper-slide-gallery">
              <div style={{
    ...
    <div className="text-primary pt-[56px] pb-[53px] px-[20px] tablet:pt-[73px] tablet:pb-[64px] tablet:px-[32px]  desktop:pt-[106px] desktop:pb-[104px] desktop:px-[104px]">
      ...
      <div className="flex flex-col tablet:flex-row tablet:gap-x-5 ">
        <div className="  tablet:flex desktop:flex-1 tablet:flex-col tablet:gap-y-10 desktop:gap-y-5 tablet:w-3/5 desktop:w-2/5">
          ...
          <p className="tablet:hidden text-right mb-2 mt-6 not-italic font-thin leading-[1] text-L">0{index+1}/<span className="text-secondary">05</span></p> 
          <Image src={itemSlide.slideImage} alt="ATVs Traveling" width={280} height={213} className="swiper-slide"/>
        ...
        <div className=" desktop:flex-1 tablet:w-2/5 desktop:w-3/5 flex flex-col desktop:flex-row desktop:gap-x-15">
          ...
          <div className="flex flex-col mb-[34px]  tablet:mb-[25px] desktop:mb-6  tablet:gap-y-10 desktop:gap-y-5">
            <p className="hidden tablet:block not-italic font-thin leading-[1] text-L tablet:text-xl tablet:leading-[78px] desktop:leading-[1] desktop:text-xxl">0{index+1}/<span className="text-secondary">05</span></p> 
            <ul className="flex flex-col gap-y-4 desktop:gap-y-6 ">
              ...
              :
              (<li  className="slideText"  onClick={() => handleSlideClick(0)}>ATVs Traveling</li>)}
              ...
              :
              (<li  className="slideText"  onClick={() => handleSlideClick(1)}>Rock climbing</li>)}
              ...
              :
              (<li  className="slideText" onClick={() => handleSlideClick(2)}>Hot air ballooning</li>)}
              ...
              :
              (<li  className="slideText" onClick={() => handleSlideClick(3)}>Skydiving</li>)}
              ...
              :
              (<li  className="slideText" onClick={() => handleSlideClick(4)}>Rafting</li>)}
